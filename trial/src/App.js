...
class App extends Component {
  ...
  toiletList:
    ...
    location: {
      lat: 1.2924024167154038,
      lng: 103.77438630260782,
    },
    zoom: 13,
  ...
  // Destructure each toilet to get coords
  // Loop through and add a marker to map for each toilet
  ...
  render(){
    ...
    return (
      <Map className="map" center={position} zoom={this.state.zoom}>
        ...
        {/* {
          this.state.toiletList.map((toilet) => {
            var coords= [toilet.location[0] , toilet.location[1]];
